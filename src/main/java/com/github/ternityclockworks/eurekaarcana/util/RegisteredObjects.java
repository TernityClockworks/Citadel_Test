...
/**
 * Complete credit to the RegisteredObjects utility class from the Create mod.
 * See <a href="https://github.com/Creators-of-Create/Create/blob/mc1.20.1/dev/src/main/java/com/simibubi/create/foundation/utility/RegisteredObjects.java"> Create RegisteredObjects class</a>
 * @author PepperCode1
 */
