...
/**
 * Complete credit to the LangBuilder utility class from the Create mod.
 * See <a href="https://github.com/Creators-of-Create/Create/blob/mc1.20.1/dev/src/main/java/com/simibubi/create/foundation/utility/LangBuilder.java"> Create LangBuilder class</a>
 */
