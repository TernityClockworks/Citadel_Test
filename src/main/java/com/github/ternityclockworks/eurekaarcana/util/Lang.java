...
/**
 * Used for somewhat automatic translation of names.
 * Complete credit to the Lang utility class from the Create mod.
 * See <a href="https://github.com/Creators-of-Create/Create/blob/mc1.20.1/dev/src/main/java/com/simibubi/create/foundation/utility/Lang.java"> Create Lang class</a>
 */
public class Lang {
	...
	public static MutableComponent translateDirect(String key, Object... args) {
		return Component.translatable(EurekaArcana.MODID + "." + key, resolveBuilders(args));
	}
	...
	public static LangBuilder builder() {
		return new LangBuilder(EurekaArcana.MODID);
	}
