...
//import com.github.ternityclockworks.eurekaarcana.server.item.EurekaBlockRegistry;
...
public class GenLootTables extends VanillaBlockLoot {
    ...
    protected void generate() {
        //dropSelf(EurekaItemRegistry.EUREKA_JOURNAL.get());
    ...
    protected Iterable<Block> getKnownBlocks() {
        return ForgeRegistries.BLOCKS.getEntries().stream()
                .filter(e -> e.getKey().location().getNamespace().equals(EurekaArcana.MODID))
