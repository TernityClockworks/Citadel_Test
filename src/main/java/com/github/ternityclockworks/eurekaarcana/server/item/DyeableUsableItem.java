 ...
 * See <a href="https://github.com/Creators-of-Create/Create/blob/mc1.20.1/dev/src/main/java/com/simibubi/create/foundation/item/CustomUseEffectsItem.java"> Create CustomUseEffectsItem</a>
 * @author PepperCode1
 */
public interface DyeableUsableItem extends DyeableLeatherItem {
	/**
