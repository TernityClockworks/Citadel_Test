...
import com.github.ternityclockworks.eurekaarcana.server.recipe.ManualCombinationRecipe.CombinationInv;
...
public class ManualCombinationRecipe extends EurekaRecipe<CombinationInv> {

	public ManualCombinationRecipe(EurekaRecipeParams params) {
		super(EurekaRecipeTypes.MANUAL_COMBINATION, params);
	}
	...
	public static List<Recipe<CombinationInv>> getMatchingRecipes(Level world, ItemStack stack) {
		return world.getRecipeManager()
			.getRecipesFor(EurekaRecipeTypes.MANUAL_COMBINATION.getType(), new CombinationInv(stack), world);
	}
